...
public class Vista_LOGIN_BBDD extends JDialog {
    ...
    private class OyenteAceptar implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            //Seteando las variables estáticas con el valor que exista en los recuadros de conexion
            ...
            Controlador.ControladorVistaPrincipal.BBDDpass = String.valueOf(EntradaPass.getPassword());
