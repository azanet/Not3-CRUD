...
public class VistaBBDD_Consultar extends JFrame {
    ...
    public static JButton BotonExportarConsulta;
...
//Creando constructor
    ...
    private void Iniciar() {
        ...
        BotonExportarConsulta = ControladorVistaPrincipal.ExportarConsultaAPestania;
        panelDescripcionSuperior.add(BotonExportarConsulta);
        ...
        textArea.setEditable(false);//Haciendo que TextArea NO SEA EDITABLE
