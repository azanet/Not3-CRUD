...
import static Vistas.VistaBBDD_Consultar.textArea;
...
public class VistaBBDD_Modificar extends JFrame {
    ...
    public TextLineNumber tln;//Objeto de LINE NUMBER
...
//Creando constructor
    ...
    private void Iniciar() {
        ...
        tituloDescripcion = new JLabel("Descripción Nueva:");
        ...
        BotonModificarDescripcion = new JButton("MODIFICAR DESCRIPCIÓN");
        BotonModificarDescripcion.setBackground(new Color(184, 255, 181));
        BotonModificarDescripcion.setBorder(BorderFactory.createEmptyBorder(15, 8, 15, 8));
        panelModificarDescripcionSuperior.add(BotonModificarDescripcion);
        ...
        tln = new TextLineNumber(textArea);//Agregando panel indicador de lineas
